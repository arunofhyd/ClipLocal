...
*   **Smart Icons**: 🏷️ Each item shows a relevant icon so your history is easy to scan — 🔗 for links, ✉️ for emails, #️⃣ for numbers, 🧑‍💻 for code, 📄 for files/notes, and 🖼️ for images.
