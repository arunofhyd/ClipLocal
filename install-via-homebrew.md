...
To install ClipLocal on a brand new Mac, you can run the following combined command in your Terminal. This will install Homebrew (if you don't already have it), add the custom repository, and install the ClipLocal application:
...
1. Try to open the **ClipLocal** app from your Applications folder.
...
5. You will see a message saying "ClipLocal" was blocked to protect your Mac. Click the **Open Anyway** button.
